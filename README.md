...
**MINFF** is a molecular dynamics (MD) forcefield that designed for Si, Al, Fe, Mg, Ca, Ti, Li, F containing oxides and hydroxides, including hydrated clay minerals and zeolites. MINFF incorporates angle terms in addition to Lennard-Jones and Coloumbic terms to maintain accurate coordination environments and unit cell metrics, and introduces new atomtypes enabling the simulation of a wide range of minerals. Results demonstrating the accuracy of MINFF compared to CLAYFF and INTERFACE for selected minerals regarding unit cell metrics, neighbour distances and angles, can be found in the MINFF_v1.xls file.

MINFF actually contains several versions of forcefield parameters, including both a **general** version, as well as a **tailor-made** and mineral specific version, having Lennard-Jones parameters optimized for over 30 mineral types. Furthermore, each general and tailor-made version is available in four different subsets, each having Lennard-Jones parameters optimized for four different angle force constants: **0, 250, 500, and 1500 kJ/mol/rad²**. MINFF test cases for hydrated montmorillonite using the general and tailored MINFF parameters (angle force constant 500 kJ/mol/rad²) can be found in the [**example cases of the atom Toolbox**](https://github.com/mholmboe/atom/tree/master/ATOM_scripts_lecture/MINFF). An online Python server also exist to analyze and setup topology files at [**www.atomipy.io**](https://www.atomipy.io).

## Implementation

MINFF has mainly been tested with Gromacs, but a few tests have also been done with LAMMPS and NAMD. MINFF atomtype assignment is implemented in [**MATLAB**](www.mathworks.com) and recent releases of [**OCTAVE**](https://octave.org) via the [**atom Toolbox**](https://github.com/mholmboe/atom) also available via this GitHub repository, which comes with HTML documentation and general examples. The [**atom Toolbox**](https://github.com/mholmboe/atom) has MATLAB/Octave functions that can write topology files (write_minff_itp, write_minff_lmp, write_minff_psf). Alternatively, a lightweight version also exist in Python called [**atomipy**](https://github.com/mholmboe/atomipy), which also has its own online server at [**www.atomipy.io**](https://www.atomipy.io). The latter can generate generic Gromacs (.itp), NAMD (.psf) and LAMMPS (.data) topology files according to MINFF as well as CLAYFF ((Cygan, Liang, Kalinichev,. Molecular Models of Hydroxide, Oxyhydroxide, and Clay Phases and the Development of a General Force Field. *J. Phys. Chem. B* **2004**, *108*, 1255-1266). The general MINFF forcefield parameters can be found in the table below. Both the general and tailored parameters can also be found in the [**ffnonbonded_(g/t)minff_k{value}.itp**](https://github.com/mholmboe/minff/tree/main/min.ff) files, sorted either by angle force constant (see above) and/or mineral. Note that the default version of the general and tailored sets of MINFF uses the Lennard-Jones parameters for the OPC3 water model for all oxygen atomtypes. There is however an alternative version (see commented out parameters) of the tailored versions of MINFF that uses independently optimized Lennard-Jones parameters for all oxygen atomtypes. 

Note that MINFF sets all O-M-O angles as found in the input structure, whereas the M-O-H angles uses angle parameters adapted from Pouvreau, Greathouse, Cygan and Kalinichev, see J. Phys. Chem. C 2019, 123, 11628−11638.

The MINFF atomtype assignment uses a nearest-neighbour algorithm to determine the atomtypes/names, and sets the (Al, Si, Mg, Fe, Ca, Ti, Li, F) corresponding partial charges. Note that the listed charges for the oxygen atomtypes in these files are just dummy examples. The actual oxygen charges is computed specifically for each mineral/system by the [**atom Toolbox**](https://github.com/mholmboe/atom) using the charge smearing equation from Lammers et al 2017 (doi:10.1016/j.jcis.2016.11.084), during the atomtype assignment (see example below). This allows for generating custom oxygen sites resulting from for instance isomorphic substitution and or terminating edge-groups in clays. Note that for MINFF versions priov v1.0, new L-J parameters have been dervied for Fe2+ and Fe3+ having higher charges (+1.184 and +1.500, respectively) than in prior versions of MINFF.

## Parameters for GMINFF

Below is the partial charges and the Lennard-Jones parameters sigma and epsilon for the general MINFF v1.0 forcefield, as a function of the different angle force constants. Units for sigma, epsilon and Ka are nm, kJ/mol and kJ/mol/rad², resp. See also the general and tailored parameters in the [**ffnonbonded_(g/t)minff_k{value}.itp**](https://github.com/mholmboe/minff/tree/main/min.ff) files.

| Atomtype | mass [amu] | charge\*  | kA=0 sigma | kA=0 epsilon | kA=250 sigma | kA=250 epsilon | kA=500 sigma | kA=500 epsilon | kA=1500 sigma | kA=1500 epsilon |  Comment                                            |
| -------- | ---------- | --------- | ---------- | ------------ | ------------ | -------------- | ------------ | -------------- | ------------- | --------------- | --------------------------------------------------- |
| H        | 1.00794    | 0.40000   | 0.000000   | 0.000000     | 0.000000     | 0.000000       | 0.000000     | 0.000000       | 0.000000      | 0.000000        |  Hydroxyl hydrogen                                  |
| He       | 1.00794    | 0.40000   | 0.000000   | 0.000000     | 0.000000     | 0.000000       | 0.000000     | 0.000000       | 0.000000      | 0.000000        |  Edge hydroxyl hydrogen                             |
| Lio      | 6.94000    | 0.86000   | 0.191606   | 0.219589     | 0.191606     | 0.219589       | 0.191606     | 0.219589       | 0.191606      | 0.219589        |  Octahedral Lio, Ex. Li2O                           |
| Oahs     | 15.99941   | \-0.66800 | 0.317427   | 0.683690     | 0.317427     | 0.683690       | 0.317427     | 0.683690       | 0.317427      | 0.683690        |  Edge O, Al-OhH-Si                                  |
| Oal      | 15.99941   | \-0.89517 | 0.317427   | 0.683690     | 0.317427     | 0.683690       | 0.317427     | 0.683690       | 0.317427      | 0.683690        |  Edge O, Al-O                                       |
| Oalh     | 15.99941   | \-1.19700 | 0.317427   | 0.683690     | 0.317427     | 0.683690       | 0.317427     | 0.683690       | 0.317427      | 0.683690        |  Edge O, Al-O-H                                     |
| Oalhh    | 15.99941   | \-0.59700 | 0.317427   | 0.683690     | 0.317427     | 0.683690       | 0.317427     | 0.683690       | 0.317427      | 0.683690        |  Edge Al-OH2 oxygen                                 |
| Oalsi    | 15.99941   | \-1.26800 | 0.317427   | 0.683690     | 0.317427     | 0.683690       | 0.317427     | 0.683690       | 0.317427      | 0.683690        |  Edge O, Al-O-Si                                    |
